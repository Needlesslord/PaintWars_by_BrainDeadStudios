...
#include "SnowMapScene.h"
#include "TransitionManager.h"

SnowScene::SnowScene() : Scene(SCENES::GAME_SCENE)
{
...
bool SnowScene::Awake(pugi::xml_node& config)
{
...
// Called each loop iteration
bool SnowScene::Update(float dt)
{
	bool ret = true;
...
void SnowScene::ExecuteTransition()
{
