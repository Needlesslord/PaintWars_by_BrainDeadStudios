...
#include "VolcanoMapScene.h"
#include "TransitionManager.h"

VolcanoScene::VolcanoScene() : Scene(SCENES::GAME_SCENE)
{
...
bool VolcanoScene::Awake(pugi::xml_node& config)
{
...
// Called each loop iteration
bool VolcanoScene::Update(float dt)
{
	bool ret = true;
...
void VolcanoScene::ExecuteTransition()
{
